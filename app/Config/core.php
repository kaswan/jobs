 ...
 */
	Configure::write('Security.salt', 'DYhG93b0fs2guVoUubWwvniRqyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '7685930965fs2guVoUubWwvniR7453542496749683645');
 ...
 */
   ...
   'engine' => 'File',
   'duration' => '+30 days',
   'prefix' => 'institution_cake_',
   'path' => CACHE . 'list' . DS,
   'serialize' => true,
   ));
   
   // Prefecture
   Cache::config('prefecture', array(
   'engine' => 'File',
   'duration' => '+999 days',
   'prefix' => 'prefecture_cake_',
   'path' => CACHE . 'list' . DS,
   'serialize' => true,
   ));

   // User
   Cache::config('user', array(
   'engine' => 'File',
   'duration' => '+10 days',
   'prefix' => 'user_cake_',
   'path' => CACHE . 'list' . DS,
   ...
   // progress_status
   Cache::config('progress_status', array(
   'engine' => 'File',
   'duration' => '+999 days',
   'prefix' => 'progress_status_cake_',
   'path' => CACHE . 'list' . DS,
   'serialize' => true,
   ));
